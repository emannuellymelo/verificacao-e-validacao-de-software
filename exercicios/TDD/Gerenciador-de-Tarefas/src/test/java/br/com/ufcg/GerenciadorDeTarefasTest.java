...
public class GerenciadorDeTarefasTest {
    ...
    public void testTarefaSemNome() {
        try {
            Tarefa tarefa = new Tarefa("    ", "Atividade criada para testar a falta de titulo", "21/12/2023", "Alta", "1");
    ...
    public void testPrioridades() {
        try {
            Tarefa tarefa = new Tarefa("Fazer exercicio de VeV", "Exercicio TDD", "25/12/2023", "Importante", "10");
    ...
    public void testTarefaAdicionada() {
        ...
        Tarefa tarefa = new Tarefa("Fazer exercicio de VeV", "Exercicio TDD", "25/12/2023", "Alta", "3");
    ...
    public void testTarefaExcluida() {
        ...
        Tarefa tarefa = new Tarefa("Fazer exercicio de VeV hoje", "Exercicio TDD", "25/12/2023", "Alta", "4");
        user.addTarefa(tarefa);
        user.removeTarefa("4");
    ...
    public void testTarefaEditada() {
        ...
        Tarefa tarefa = new Tarefa("Fazer exercicio de VeV", "Exercicio TDD", "25/12/2023", "Media", "5");
        user.addTarefa(tarefa);
        user.editTarefa("Fazer exercicio de VeV hoje", "Exercicio TDD", "25/12/2023", "Alta", "5");
    ...
    public void testListagemMesmaDataPrioridadesDiferentes() {
        ...
        Tarefa tarefa1 = new Tarefa("Fazer exercicio de BD", "Exercicio Diagrama", "25/12/2023", "Media", "6");
        Tarefa tarefa2 = new Tarefa("Fazer exercicio de VeV", "Exercicio TDD", "25/12/2023", "Alta", "7");
    ...
    public void testListagemMesmaPrioridadeDatasDiferentes() {
        ...
        Tarefa tarefa1 = new Tarefa("Fazer exercicio de BD", "Exercicio Diagrama", "25/12/2023", "Media", "8");
        Tarefa tarefa2 = new Tarefa("Fazer exercicio de VeV", "Exercicio TDD", "08/12/2023", "Media", "9");
        user.addTarefa(tarefa1);
        user.addTarefa(tarefa2);
        assertEquals( "Fazer exercicio de VeV", user.getTarefas().get(0).getTitulo());
    }
